...
if (isset($_GET['id'])){
    ...
    // value="<?php echo $_POST['unname'] ?? $_result['uname']; />"    null coalescing oparater//
    ...
    try{
        ...
        if (isset($_POST['SENT'])){
            ...
            if(empty($msg)){
                ...
                if($ok) $okmsg = "Contact is updates successfully";
            }
    ...
    <div id="msg" class="err"><?php if(!empty($msg)) echo $msg; ?></div>
        ...
        <form onsubmit="return validate()" name="form1" method="POST" action="edit.php?id=<?php echo $_GET['id']; ?>">
            ...
            <label class="row">
                ...
                <textarea maxlength="160" class="in1" name="address"value="<?php echo isset($_POST['SENT']) && empty($okmsg) ? $_POST['address'] : $result['address']; ?>"></textarea>
            </label>
            <label class="row">
            ...
            <label class="row">
                ...
                <textarea maxlength="160" class="in1" name="note" value="<?php echo isset($_POST['SENT']) && empty($okmsg) ? $_POST['note'] : $result['note']; ?>"></textarea>
            </label>
            <div class="row">
